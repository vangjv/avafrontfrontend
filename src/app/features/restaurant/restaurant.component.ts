...
export class RestaurantComponent implements OnInit, OnDestroy{
  ...
  async initializeAvatar() {
    ...
    try {
      await this.head.showAvatar({
        url: 'https://models.readyplayer.me/66390c8f0f8b88612acb63f8.glb?morphTargets=ARKit,Oculus+Visemes,mouthOpen,mouthSmile,eyesClosed,eyesLookUp,eyesLookDown&textureSizeLimit=1024&textureFormat=png',
        body: 'F',
        avatarMood: 'neutral',
        ttsLang: "en-GB",
  ...
  async microsoftSpeak(s: any, node = null) {
    if (s === null) {
      ...
      const id = "en-US-EmmaMultilingualNeural"
      const lang = "en-US";

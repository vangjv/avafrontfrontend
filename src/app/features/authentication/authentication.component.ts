  ...
  async initializeAvatar() {
    ...
    try {
      await this.head.showAvatar({
        url: 'https://models.readyplayer.me/66392adbedc0c349c6c74c0e.glb?morphTargets=ARKit,Oculus+Visemes,mouthOpen,mouthSmile,eyesClosed,eyesLookUp,eyesLookDown&textureSizeLimit=1024&textureFormat=png',
        body: 'F',
        avatarMood: 'neutral',
        ttsLang: "en-GB",
